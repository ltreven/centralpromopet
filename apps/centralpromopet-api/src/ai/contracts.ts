...
export const planSchema = z.object({
  search: z.object({ query: z.string().max(160), petType: z.enum(['dogs', 'cats', 'all']), evidence: z.string().max(300).optional() }).nullable(),
